...
import svgPaths from "./svg-8w1e6fmxk4";
...
import { imgGeminiGeneratedImage87B3S887B3S887B31, imgGeminiGeneratedImage2Lw4Iv2Lw4Iv2Lw41 } from "./svg-fukk2";

function TreesLeft() {
  return (
    <div className="-translate-x-1/2 absolute bottom-[37.83px] contents left-[calc(50%-36px)]" data-name="trees-left">
      <div className="-translate-x-1/2 absolute bottom-[37.83px] h-[477.17px] left-[calc(50%-36px)] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[700px_477.17px] w-[700px]" data-name="Gemini_Generated_Image_87b3s887b3s887b3 1" style={{ maskImage: `url('${imgGeminiGeneratedImage87B3S887B3S887B31}')` }}>
...
function TreesRight() {
  return (
    <div className="absolute bottom-[-0.74px] contents right-[-218px]" data-name="trees-right">
      <div className="absolute bottom-[-0.74px] h-[593.736px] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0px] mask-size-[871px_593.736px] right-[-218px] w-[871px]" data-name="Gemini_Generated_Image_2lw4iv2lw4iv2lw4 1" style={{ maskImage: `url('${imgGeminiGeneratedImage2Lw4Iv2Lw4Iv2Lw41}')` }}>
...
function Hero() {
  ...
  return (
    <div ref={ref} className="h-[762px] overflow-clip relative shrink-0 w-full" data-name="Hero">
      <motion.div style={{ y: yBg }} className="-translate-x-1/2 absolute bottom-[-139px] h-[732px] left-[calc(50%+1px)] w-[1786px]" data-name="bg-baby">
      ...
      <motion.div style={{ y: yAnimals }} className="-translate-x-1/2 absolute bottom-[-16px] h-[303px] left-[calc(50%-0.5px)] w-[1487px]" data-name="animals">
...
function Frame4() {
  return (
    <a
      ...
      className="bg-[#c1b86a] content-stretch flex gap-[8px] items-center justify-center p-[16px] relative rounded-[16px] shrink-0 active:bg-[#b0a75a] no-underline"
    >
      <Frame />
    ...
    <div className="backdrop-blur-[10px] bg-[#f2eee5] flex-[1_0_0] min-h-px min-w-px relative rounded-[32px]">
      ...
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col font-bold items-center justify-center leading-[normal] pb-[32px] pt-[24px] px-[8px] relative text-center w-full whitespace-nowrap">
          <p className="relative shrink-0 text-[#273421] text-[56px]">{String(value).padStart(2, '0')}</p>
    ...
    <div className="backdrop-blur-[10px] bg-[#f2eee5] flex-[1_0_0] min-h-px min-w-px relative rounded-[32px]">
      ...
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col font-bold items-center justify-center leading-[normal] pb-[32px] pt-[24px] px-[8px] relative w-full whitespace-nowrap">
          <p className="relative shrink-0 text-[#273421] text-[56px] text-center">{String(value).padStart(2, '0')}</p>
...
function Frame12() {
  ...
  return (
    <button
      ...
      className="bg-[#f5ac57] content-stretch flex gap-[8px] items-center justify-center p-[16px] relative rounded-[16px] shrink-0 active:bg-[#e69b46] transition-colors cursor-pointer border-none"
    >
      <Frame13 />
      <Frame14 />
    </button>
...
function Frame15() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Frame">
          <path d={svgPaths.p3823abb0} fill="var(--fill-0, #A39C5A)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function DateSection() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#d7cd76] content-stretch flex gap-[16px] items-center justify-center left-1/2 px-[32px] py-[16px] rounded-[24px] top-[715px]" data-name="Date">
      ...
      <Frame15 />
      <p className="font-bold leading-[normal] relative shrink-0 text-[#1f2a1c] text-[24px] text-center whitespace-nowrap">12 de Abril, 2026</p>
    </div>
  );
}
