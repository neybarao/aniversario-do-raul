import svgPaths from "./svg-f11sjb40e3";
...
import imgGeminiGeneratedImage2C8Wmn2C8Wmn2C8W1 from "figma:asset/0cb98f0389972eec09fd28028c649adfa52c1b35.png";
...
import imgGeminiGeneratedImageJ1Bqwtj1Bqwtj1Bq1 from "figma:asset/1481d0692724a65446fa2e67a52294d8872ee697.png";
import { imgGeminiGeneratedImage87B3S887B3S887B31, imgGeminiGeneratedImage2Lw4Iv2Lw4Iv2Lw41 } from "./svg-fxvjj";
...
function Frame12() {
  return (
    <div className="bg-[#f5ac57] content-stretch flex gap-[8px] items-center justify-center p-[16px] relative rounded-[16px] shrink-0">
      <Frame13 />
      <Frame14 />
    </div>
  );
